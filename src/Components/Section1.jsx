...
export default function Section1() {
  return (
    <div
      id="home"
      className="scroll-smooth w-full overflow-x-hidden bg-gradient-to-r from-blue-50 via-white to-blue-100 min-h-screen mt-20"
    >
      <div className="flex flex-col md:flex-row justify-between items-center py-10 px-10 md:px-20">
        <div className="flex flex-col gap-4 text-black justify-center mt-10">
          ...
          <Link
            ...
            duration={500}
            offset={-70}
            className="flex items-center gap-2 w-fit mt-6 px-6 py-3 bg-blue-600 text-white rounded-md cursor-pointer hover:bg-blue-700 transition shadow-lg"
          >
        ...
        <div className="flex justify-center mt-10 md:mt-0 w-full md:w-[800px]">
          <img
            src="/imagee.png"
            alt="Portrait de Mohammed Tonzar"
