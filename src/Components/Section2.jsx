    ...
    <div className="flex flex-col md:flex-row items-center justify-center m-10 py-10 gap-16" id="about"> 
      ...
      <div className="w-full md:w-[60%] space-y-6">
        ...
        <p className="text-lg text-gray-600 text-justify">
          Diplômé d'un <strong>Master MIAGE</strong> à l’Université Côte d’Azur,
          je travaille chez <strong>CGI</strong> en tant que
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Label nom={<><FaMapMarkerAlt className="inline mr-2 text-blue-500"/> Ville</>} valeur="Nice, France" />
        </div>
